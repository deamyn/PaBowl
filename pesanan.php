                ...
                <table class="table table-bordered" style="text-align:center;">
                    <thead>
                        ...
                        <tbody>
							...
							<tr>
                                <?php if ($result["status_pesanan"] == ("batal" or "selesai")) {?>
                                    <td><?= $result["id_user"]; ?></td>
                                    <td><?= $result["nama"]; ?></td>
                                    <td><?= $result["no_hp"]; ?></td>
                                    <td><?= $result["alamat"]; ?></td>
                                    <td><?= $result["pesanan"]; ?></td>
                                    <td><?= $result["total_harga"]; ?></td>
                                    <td colspan="2"><?= $result["status_pesanan"]; ?></td>
                                <?php } else {?>
                                    <td><?= $result["id_user"]; ?></td>
                                    <td><?= $result["nama"]; ?></td>
                                    <td><?= $result["no_hp"]; ?></td>
                                    ...
                                    <td><?= $result["pesanan"]; ?></td>
                                    <td><?= $result["total_harga"]; ?></td>
                                    <td><a href="tolak.php" class="btn btn-danger">Tolak</a></td>
                                    <td><a href="terima.php" class="btn btn-success">Terima</a></td>
                                    <?php } ?>
                            </tr>
                            <?php } ?>
