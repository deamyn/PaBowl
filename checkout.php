  ...
  <section id="cart" class="cart d-flex align-items-center section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="untree_co-section before-footer-section">
        <div class="progress">
          <div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: 50%; padding-bottom: 40px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-5 mb-md-0">
                <div class="p-3 p-lg-5 border bg-white">
                  ...
                  <div class="form-group row">
                    <div class="col-md-8">
                      <label for="c_alamat" class="text-black">Alamat <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="c_alamat" name="c_alamat" placeholder="Street alamat">
                    </div>
                  </div>

                  <div class="form-group mt-3">
                    <input type="text" class="form-control" placeholder="Apartment, suite, unit etc. (optional)" style="padding-bottom: 40px;">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="c_ship_different_alamat" class="text-black" data-bs-toggle="collapse" href="#ship_different_alamat" role="button" aria-expanded="false" aria-controls="ship_different_alamat"><input type="checkbox" value="1" id="c_ship_different_alamat"> Ship To A Different alamat?</label>
                    <div class="collapse" id="ship_different_alamat">
                      <div class="py-2">
                        ...
                        <div class="form-group row">
                          <div class="col-md-8">
                            <label for="c_diff_companyname" class="text-black">No. HP </label>
                        ...
                        <div class="form-group row  mb-3">
                          <div class="col-md-8">
                            <label for="c_diff_alamat" class="text-black">Alamat <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="c_diff_alamat" name="c_diff_alamat" placeholder="Street alamat">
                          </div>
                        </div>
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="p-3 p-lg-5 border bg-white">
                      <table class="table site-block-order-table mb-5">
                        ...
                        <tbody>
                        <tr>
                            <td>Pa-Bowl 1 <strong class="mx-2">x</strong> 1</td>
                            <td>Rp15.000</td>
                          </tr>
                          <!-- <tr>
                            <td>Pa-Bowl Special 2 <strong class="mx-2">x</strong> 1</td>
                            <td>Rp18.000</td>
                          </tr>
                          <tr>
                            <td>Kerupuk Kulit <strong class="mx-2">x</strong>   1</td>
                            <td>Rp3.000</td>
                          </tr> -->
                          <tr>
                            <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                            <td class="text-black">Rp15.000</td>
                          </tr>
                          <tr>
                            <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                            <td class="text-black font-weight-bold"><strong>Rp15.000</strong></td>
                          </tr>
                        </tbody>
                      </table>

                      <div class="form-group">
                        <button class="btn btn-black btn-lg py-3 btn-dark" onclick="window.location='thankyou.php'">Bayar</button>
                      </div>
