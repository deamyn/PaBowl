				...
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<form action="#" class="signin-form">
							...
							<div class="form-group">
								<button type="submit" class="form-control btn btn-primary"><a href="./user.php" style="color: white;">Log In</a></button>
							</div>
						...
						<div class="social d-flex text-center">
							<a href="login2.php" class="px-2 py-2 mr-md-1 rounded"> Login as An Admin</a>
